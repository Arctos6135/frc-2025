...
public class IntakePiece {
  ...
  public static void intakeOuttakeMove(Intake intake, double intakeRPS, Outtake outtake, double outtakeRPS){
  ...
  public static Command badIntakePiece(Intake intake, Outtake outtake){
    return new StartEndCommand(
      () -> intakeOuttakeMove(intake, IntakeConstants.INTAKE_RPS, outtake, OuttakeConstants.OUTTAKE_RPS), 
      () -> intakeOuttakeMove(intake, 0, outtake, 0), intake, outtake
    )
