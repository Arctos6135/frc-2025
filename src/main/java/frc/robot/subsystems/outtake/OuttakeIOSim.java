...
public class OuttakeIOSim extends OuttakeIO {
    ...
    public OuttakeIOSim() {
        leftMotor = new DCMotorSim(OuttakeConstants.OUTTAKE_LINEAR_SYSTEM, DCMotor.getNeo550(1), null); // TODO std and type of motor
    ...
    public void updateInputs(OuttakeInputs inputs) {
        ...
        inputs.leftVelocity = leftMotor.getAngularVelocityRPM() * OuttakeConstants.VELOCITY_CONVERSION_FACTOR;
        inputs.rightVelocity = rightMotor.getAngularVelocityRPM() * OuttakeConstants.VELOCITY_CONVERSION_FACTOR;
